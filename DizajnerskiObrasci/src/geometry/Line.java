...
public class Line extends Shape {
	...
	public String toString() {
		return "Line: start point x=" + startPoint.getX() + "; start point y=" + startPoint.getY() + "; end point x="
				+ endPoint.getX() + "; end point y=" + endPoint.getY() + "; color="
				+ getColor().toString().substring(14).replace('=', '-');
	}

	@Override
	public Line clone(Shape ll) {
		Line l = (Line) ll;
